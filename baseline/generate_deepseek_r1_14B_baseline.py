...
def ask_deepseek_r1_14B(prompt):
    """
    使用 deepseek_r1_14B_baseline 来回答问题（仅文本 Prompt）。
        ...
        for line in f:
            ...
            try:
                ...
                if is_complex:
                    ...
                    # 使用正则表达式剔除"###End RAG used context:###"之后的内容
                    context = re.sub(r'###End RAG used context:###.*$', '', context, flags=re.DOTALL).strip()
